...
public class LLevelGenerator : MonoBehaviour
{
    ...
    public static LLevelGenerator llv;
    ...
    public void SpawnCylinder()
    {
        ...
        if (previous_cylinder == null)
        {
            previous_cylinder = Instantiate(cylinder, new Vector3(0,0,0) ,Quaternion.identity);
            previous_cylinder.transform.parent = level2.transform;
        }
        ...
        if (odunsayisi == windowtreenumber + 1)
        {
            ...
            tree.transform.parent = level2.transform;
        }
